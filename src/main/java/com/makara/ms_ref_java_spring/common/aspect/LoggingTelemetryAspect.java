package com.makara.ms_ref_java_spring.common.aspect;
...
public class LoggingTelemetryAspect {
    ...
    @Pointcut("within(@com.makara.ms_ref_java_spring.common.aspect.LoggedApi *)")
    public void loggedApiClass() {}

    @Pointcut("@annotation(com.makara.ms_ref_java_spring.common.aspect.LoggedApi)")
